...
rocket: RocketChat = RocketChat(
    "wiktor_gladys", "admin123", server_url="http://172.17.0.4:3000"
)
...
class RedmineManager:
    ...
    def prepare_list(self) -> List[List[str]]:
...
TRACKER_ID: int = 1
PRIORITY_ID: int = 1
ROOM_ID: str = "8PXbmuGqaDBF7LHHG9bqzNeAyjJGS6Y7Zr"
...
# INITIALIZATION
list_: List[List[str]] = redmine_manager.prepare_list()
# ic(list_)
